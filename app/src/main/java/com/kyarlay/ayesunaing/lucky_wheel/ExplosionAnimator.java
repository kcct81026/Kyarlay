...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private ExplosionAnimator.Particle[] mParticles;
    private Rect mBound;
    ...
    public ExplosionAnimator(View container, Bitmap bitmap, Rect bound) {
        ...
        int partLen = 15;
        mParticles = new ExplosionAnimator.Particle[partLen * partLen];
    ...
    private ExplosionAnimator.Particle generateParticle(int color, Random random) {
        ExplosionAnimator.Particle particle = new ExplosionAnimator.Particle();
