...
public class PielView extends View {
    ...
    private void drawSecondaryText(Canvas canvas, float tmpAngle, String mStr, int backgroundColor) {
        ...
        if (MDetect.INSTANCE.isUnicode()){
            typeface = AppController.typefaceManager.getCompanion().getPYIDAUNGSU();

        }
        else{
            typeface = AppController.typefaceManager.getCompanion().getZAWGYITWO();
