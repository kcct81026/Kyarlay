...
public class FragmentUsed extends Fragment implements Constant, ConstantVariable {

    private static final String TAG = "FragmentUsed";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prefs.saveIntPerferences(SP_PAGE_SUPER, SP_DEFAULT);
    ...
    private void getPointInfoNew()
    {
        ...
        final JsonArrayRequest jsonArrayReq = new JsonArrayRequest(constantPointGetReceivedHistory +  LANG + "=" + prefs.getStringPreferences(SP_LANGUAGE) + "&type=used&page=" + prefs.getIntPreferences(SP_PAGE_SUPER),

                new Response.Listener<JSONArray>() {

                    @Override
                    public void onResponse(JSONArray response) {
                        Log.e(TAG, "onResponse: ------------"  +  constantPointGetReceivedHistory +  LANG + "=" + prefs.getStringPreferences(SP_LANGUAGE) + "&type=used&page=" + prefs.getIntPreferences(SP_PAGE_SUPER) );
                        ...
                        if(response.length() > 0) {
                            ...
                            loading = false;
                            prefs.saveIntPerferences(SP_PAGE_SUPER, prefs.getIntPreferences(SP_PAGE_SUPER) + SP_DEFAULT);
