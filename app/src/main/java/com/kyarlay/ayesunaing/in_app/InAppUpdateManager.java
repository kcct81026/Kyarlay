package com.kyarlay.ayesunaing.in_app;
...
public class InAppUpdateManager implements LifecycleObserver {
    ...
    private void checkForUpdate(final boolean startUpdate) {
        ...
        Log.e(TAG, "checkForUpdate: "  + "mehtod check ***************** " + startUpdate);
        Log.e(TAG, "checkForUpdate: "  + "mehtod check ***************** " + appUpdateManager.getAppUpdateInfo());
        ...
        appUpdateInfoTask.addOnSuccessListener(new OnSuccessListener<AppUpdateInfo>() {
            ...
            public void onSuccess(AppUpdateInfo appUpdateInfo) {
                ...
                if (startUpdate) {
                    ...
                    Log.e(TAG, "onSuccess: startUpdate true "   );

                    if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE) {

                        Log.e(TAG, "onSuccess: update available " );
                        // Request the update.
                        if (mode == Constants.UpdateMode.FLEXIBLE && appUpdateInfo.isUpdateTypeAllowed(AppUpdateType.FLEXIBLE)) {
                            // Start an update.
                            Log.e(TAG, "onSuccess: "  + "FLEXIBLE" );
                            startAppUpdateFlexible(appUpdateInfo);
                        } else if (appUpdateInfo.isUpdateTypeAllowed(AppUpdateType.IMMEDIATE)) {
                            // Start an update.
                            Log.e(TAG, "onSuccess: "  + "IMMEDIATE" );
    ...
    private void startAppUpdateFlexible(AppUpdateInfo appUpdateInfo) {
        try {
            ...
            Log.e(TAG, "startAppUpdateFlexible: " + "FLEXIBLE" );
