           ...
           /* case VIEW_TYPE_SHOPPING_CART_ITEM:{
            ...
            case VIEW_TYPE_SHOPPING_CART_SUMMARY:{
                ...
                if (prefs.getIntPreferences(SP_CUSTOMER_FLASH_DISCOUNT) > 0){
                    Log.e(TAG, "onBindViewHolder: ---------------------- 810  flash "  + prefs.getIntPreferences(SP_CUSTOMER_FLASH_DISCOUNT) );
                    ...
                    Log.e(TAG, "onBindViewHolder: ---------------------- 810  else flash "  + prefs.getIntPreferences(SP_CUSTOMER_FLASH_DISCOUNT) );
                ...
                if (prefs.getIntPreferences(SP_CUSTOMER_PRODUCT_DISCOUNT) > 0){
                    Log.e(TAG, "onBindViewHolder: ---------------------- 810 product "  + prefs.getIntPreferences(SP_CUSTOMER_PRODUCT_DISCOUNT) );
                    ...
                    Log.e(TAG, "onBindViewHolder: ---------------------- 810 product else "  + prefs.getIntPreferences(SP_CUSTOMER_PRODUCT_DISCOUNT) );

                }


                if (prefs.getIntPreferences(SP_CUSTOMER_MEMBER_DISCOUNT) > 0){
                    Log.e(TAG, "onBindViewHolder: ---------------------- 810 member "  + prefs.getIntPreferences(SP_CUSTOMER_MEMBER_DISCOUNT) );
                    ...
                    Log.e(TAG, "onBindViewHolder: ---------------------- 810 member else "  + prefs.getIntPreferences(SP_CUSTOMER_MEMBER_DISCOUNT) );
