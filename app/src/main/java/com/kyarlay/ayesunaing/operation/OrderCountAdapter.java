...
public class OrderCountAdapter extends ArrayAdapter<Supplier> {

    AppCompatActivity activity;
    ArrayList<Supplier> objects;
    int productPrice;
    public OrderCountAdapter(Context context, AppCompatActivity activity, int textViewResourceId, ArrayList<Supplier> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.delivery_fee_spinner_layout, null);
